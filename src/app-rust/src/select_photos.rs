...
pub fn Select_photos() -> Element {
    ...
    let mut construction_year = use_signal(|| String::new());
    ...
    let mut folder_description = use_signal(|| String::new());
    ...
    div {
        label { class: "block text-gray-700 mb-1", "Nome da pasta" }
        input {
    ...
    div {
        ...
        input {
            ...
            oninput: move |e| folder_description.set(e.value())
        }
    }
    div {
        label { class: "block text-gray-700 mb-1", "Ano de construção" }
        input {
            class: "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
            r#type: "number",
            placeholder: "Ex: 2001",
            value: "{construction_year()}",
            oninput: move |e| construction_year.set(e.value())
        }
    }
    div {
        label { class: "block text-gray-700 mb-1", "Responsável" }
        input {
            class: "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
            r#type: "text",
    ...
    div {
        label { class: "block text-gray-700 mb-1", "Tipo de estrutura" }
        input {
            class: "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
            r#type: "text",
            placeholder: "Ex: Maria Oliveira",
            ...
            button {
                ...
                onclick: move |_| {
                        ...
                        button {
                            ...
                            onclick: move |_| {
                                dioxus::desktop::window().new_window(
                                    VirtualDom::new(ManualProcessor),
                                    Default::default(),
                                );
                            },
                            i { class: "material-icons", "folder" }
